    ...
    private void setTransformer() {
        ...
        rightSideBar.setTransformer(new Transformer() {
            ...
            private void animateOut(View view) {
                ...
                ObjectAnimator translationX = ObjectAnimator.ofFloat(view, "rotationX", 0,270, 0);
    ...
    public void onClick(View view) {
        if (view instanceof TextView) {
            ...
            if (title.startsWith("星期")) {
                ...
                startActivity(seconde.newIntent(this, title));
            }
        } else if (view.getId() == R.id.userInfo) {
            startActivity(seconde.newIntent(this, "个人中心"));
        }
    }
}
